  ...
  mounted() {
    ...
    DomSize.bind(this.$refs.echartsWord, () => {
      ...
      let minSize = Math.min(
        this.$refs.echartsWord.clientWidth,
        this.$refs.echartsWord.clientHeight
      );
  ...
  methods: {
    ...
    queryLinkData(linkageCondi) {
      ...
      if (
        ...
        this.yAxis1Data.length === 0 &&
        this.yAxis2Data.length === 0
      ) {
        return;
      }
      let dataType = 1;
    ...
    initCharts() {
      ...
      if (_this.$refs.echartsWord) {
        minSize = Math.min(
          _this.$refs.echartsWord.clientWidth,
          _this.$refs.echartsWord.clientHeight
        );
      }
