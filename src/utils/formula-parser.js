...
exports.extractSheetName = extractSheetName;
 ...
 */
function extractSheetName(sheet) {
...
var Parser = function (_Emitter) {
  ...
  Parser.prototype._callCellValue = function _callCellValue(label, sheet) {
    label = label.toUpperCase();
    sheet = sheet ? (0, _cell.extractSheetName)(sheet) : sheet;

    var _extractLabel = (0, _cell.extractLabel)(label),
        row = _extractLabel[0],
        column = _extractLabel[1];

    var cellCoord = { label: label, row: row, column: column };
    var value = void 0;
    ...
    this.emit('callCellValue', cellCoord, function (_value) {
      value = _value;
    });
