<template>
  <el-container class="dataset-page" v-loading="loading">
    ...
    <el-container style="height:calc(100% - 50px)">
          ...
          <div class="datasource-info">
            <div class="datasource-select">
              ...
              <span>
                ...
                <el-tooltip v-show = "isShowDiv" class="item" effect="dark" content="属性" placement="top">
                  <i class="left-opt-icon icon-A10562_prompt" v-popover:popover></i>
                </el-tooltip>
              </span>
            </div>
            <div class="schema-select" v-if = "isShowDiv">
              <div class="col-title">
              ...
              >
                ...
                >
                  <span class="col-span" :title="item.phy_tab_name">
                    <span v-if="!isShowDiv">{{ item.tab_chs_name }}</span>
      ...
      <el-main class="design-main">
        ...
        >
          <div
            class="pane"
            :style="{ minHeight: '100px',height:'150px', maxHeight:topMaxHeight+'px' }"
            v-show="!isHideTop"
          >
            <el-container class="dataset-right-top">
              <el-header height="22px" style="padding:16px 20px 20px;">
                <MainTitle title="实体关系拓扑" style="height:22px;"></MainTitle>
              </el-header>
              <el-main style="margin:0; padding:20px; height:100%" class="entity-rela-cont">
                <el-scrollbar style="height:100%;" :native="false" :noresize="false" tag="section">
                  <div
                    class="entity-rela"
                    :style="{'min-height':topoAreaMinH+'px'}"
                    style="min-width:100%"
                  >
                    <div v-if="entityData.length == 0" class="entity-opt-tooltip">请拖入左侧的表</div>
                    <nested-draggable
                      :tasks="entityData"
                      :isFirstWrap="isFirstWrap"
                      :parentTabInfo="parentTabInfo"
                      @emitQueryTabFields="queryTabFields"
                      @emitTabCkEvent="handleTabCkEvent"
                      @emitSaveConnSetting="saveConnSetting"
                      @emitUpdateTabsRelation="updateTabsRelation"
                      @emitConnSelOptions="setConnSelectOptions"
                    />
                  </div>
                </el-scrollbar>
              </el-main>
                ...
                <el-header height="34px" style="padding:0">
                  ...
                  <div style="float:right;margin-top:-2px;">
                    <el-input
                      ...
                      id="auto_col_search"
                    ></el-input>
                    <div class="tool-btn" @click="datasetfilterDialogVisible=true">
                      <span class="icon-A10184_filter tool-btn-icon" style="vertical-align:-1px;"></span>
                      <span class="tool-btn-text">过滤器</span>
                    </div>
                  </div>
                </el-header>
                <el-container style="position:relative;overflow:hidden;">
                  <el-aside width="50%" style="padding: 0 10px 0 0;">
                    <el-table
                      size="mini"
                      ref="table1"
                      :data="table1DataTest"
                      ...
                      :row-key="getRowKeys"
                    >
                      <el-table-column label="维度" show-overflow-tooltip>
                      ...
                      <el-table-column label="字段类型" show-overflow-tooltip width="80px">
                        <template slot-scope="scope">
                        ...
                        <template slot-scope="scope">
                          ...
                          >
                            <i
                              ...
                              @click.prevent="hideRow(scope.$index, scope.row, 1)"
                            ></i>
                          </el-tooltip>
                          <el-tooltip class="item" effect="dark" content="切换" placement="top-start">
                            <i
                              class="dataset-opt-icon icon-A10236_change"
                              @click.prevent="moveRow(scope.$index,scope.row,1)"
                            ></i>
                          </el-tooltip>
                          <el-popover
                            placement="bottom"
                            title
                            :ref="'menuPopover1'+scope.$index"
                            trigger="click"
                          >
                            <div ref="menu1" class="tb-contextMenu" x-placement="bottom-start">
                              ...
                              >
                                <li
                                  ...
                                  @click.prevent="copyRow(scope.$index,scope.row,1)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  role="menuitem"
                                  class="el-cascader-menu__item"
                                  @click.prevent="delFieldRow(scope.$index,scope.row,1,$event)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  role="menuitem"
                                  class="el-cascader-menu__item"
                                  @click.prevent="openDimChooseDialog(scope.$index,scope.row)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  role="menuitem"
                                  class="el-cascader-menu__item"
                                  @click.prevent="cancelDimBind(scope.$index,scope.row)"
                                ...
                                <li
                                  ...
                                  @mouseenter="showDateFormatList(scope.$index,scope.row,1,$event)"
                                ...
                                >
                                  <ul style="line-height: 35px;">
                                    <li
                                      ...
                                      :label="item.label"
                                      :value="item.index"
                                      @click="saveColDateFormat(scope.$index,scope.row,item,$event)"
                                    >
                                      <i
                                ...
                                <li
                                  tabindex="-1"
                                  role="menuitem"
                                  :class="['el-cascader-menu__item',scope.row.is_data_priv==0 && curAuthField != ''?'item-disabled':'']"
                                  @click.prevent="setAuthField(scope.$index,scope.row,1,$event)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                            ...
                            <span
                              class="dataset-opt-icon"
                              slot="reference"
                              @click.prevent="showMenu(scope.$index,scope.row,1,$event)"
                            >
                              <el-tooltip
                                class="item"
                                effect="dark"
                  ...
                  <el-main style="padding: 0 0 0 10px;width:50%">
                    <el-table
                      size="mini"
                      ref="table2"
                      :data="table2Data"
                      ...
                      :row-key="getRowKeys"
                    >
                      <el-table-column label="度量" show-overflow-tooltip>
                        <template slot-scope="scope">
                      ...
                      <el-table-column label="字段类型" width="130px" show-overflow-tooltip>
                        <template slot-scope="scope">
                          <!-- 计算字段用既定的字段类型 -->
                        ...
                        <template slot-scope="scope">
                          ...
                          >
                            <i
                              class="dataset-opt-icon"
                              :class="scope.row.is_show == '1'?'icon-A10181_browseCount':'icon-A10493-Invisible'"
                              @click.prevent="hideRow(scope.$index, scope.row, 2)"
                            ></i>
                          </el-tooltip>
                          <el-tooltip
                            class="item"
                          ...
                          >
                            <i
                              class="dataset-opt-icon icon-A10236_change"
                              @click.prevent="moveRow(scope.$index,scope.row,2)"
                            ></i>
                          </el-tooltip>
                          <el-popover
                            placement="bottom"
                            title
                            :ref="'menuPopover2'+scope.$index"
                            trigger="click"
                          >
                            <div ref="menu1" class="tb-contextMenu" x-placement="bottom-start">
                              <ul
                              ...
                              >
                                <li
                                  ...
                                  role="menuitem"
                                  class="el-cascader-menu__item"
                                  @click.prevent="copyRow(scope.$index,scope.row,2)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  class="el-cascader-menu__item"
                                  v-if="scope.row.is_calcul != '0'"
                                  @click.prevent="editComputedField(scope.$index,scope.row,2)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  role="menuitem"
                                  class="el-cascader-menu__item"
                                  @click.prevent="delFieldRow(scope.$index,scope.row,2,$event)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                ...
                                <li
                                  ...
                                  role="menuitem"
                                  :class="['el-cascader-menu__item',scope.row.is_data_priv==0 && curAuthField != ''?'item-disabled':'']"
                                  @click.prevent="setAuthField(scope.$index,scope.row,2,$event)"
                                >
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                            ...
                            <span
                              class="dataset-opt-icon"
                              slot="reference"
                              @click.prevent="showMenu(scope.$index,scope.row,2,$event)"
                            >
                              <el-tooltip
                                class="item"
                                effect="dark"
                      ...
                      <el-table-column align="center" width="60px">
                        <template slot="header" slot-scope="scope">
                          <el-tooltip
                            ...
                            placement="top-start"
                          >
                            <i class="dataset-opt-icon icon-A10072_add" @click="openComputedDialog"></i>
                          </el-tooltip>
                        </template>
                      </el-table-column>
                    </el-table>
    ...
    >
      <el-container class="attr-dialog-wrap">
        <el-aside width="105px" class="radio-aside-wrap">
          ...
          <el-radio v-model="fieldAttrRadio" label="1">物理字段名</el-radio>
          <!-- 如果描述为空，直接不能点 -->
          <el-radio
    ...
    <el-dialog
      size="mini"
      title="编辑计算字段"
      :visible.sync="computedDialogVis"
      :close-on-click-modal="false"
      @close="computedFieldCancel"
      width="700px"
    >
      <ComputedField
        ref="computedField"
        :editField="editField"
        :editFieldIdx="editFieldIdx"
        :allFileds="computeFields"
        :fieldTypeList="fieldTypeList"
        :cpFieldInfo="cpFieldInfo"
      ></ComputedField>
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="computedFieldCancel">取 消</el-button>
        <!-- @click="fieldAttrCancel" @click="fieldAttrConfirm" -->
...
import nestedDraggable from "../components/tools/NestedDraggable.vue";
...
export default {
  ...
  methods: {
      ...
      this.querySchemaList(param).then(resp=>{
        if (resp.status === 200 && resp.data.respResult === '1') {
          ...
          if(respData[0].connId){  //数据资产
            ...
            this.schemaList = arry;  //这里是用户模式
          }else{  //数据库
            if(curDataSrc.dsType === 'postgresql'){    //pg库需要类型
               this.schemaList = respData[0].schemaNameList;
            }else{  //其他数据库类型就是其用户模式
               this.schemaList = [];  //先清空
               for(var p = 0 ; p < respData.length ; p++){
                  this.schemaList.push(respData[p].dbName);
               }
          ...
          if(operate==='setValue'){
            ...
            if(curDataSrc.dsType === 'postgresql'){ //pg数据库
    ...
    getEntityList(val, curDataSrc,pgDataName) {  //添加pg数据库名称参数
      ...
      if (curDataSrc.parentResourceTypeId === "dataasset") {   //资产
        ...
        param = {
          dgwConnId: this.connId || "D8CF9DC45FD11433981359E0E0A911E8",
          // dataAssetConnId: this.schemaConnIdMap[this.schemaValue],
          dataAssetConnId:this.connId || "D8CF9DC45FD11433981359E0E0A911E8",
        ...
        for (let index = 0; index < (paramList || []).length; index++) {
            ...
            if (element.paramName === "tns") {
                console.info(element.paramValue);
                dsDbType = element.paramValue.split(":")[1];
                break;
            }
        }
        //设置资源类型
        console.info("类型",dsDbType);
    ...
    queryDataSet() {
      ...
      if (this.curResourceTypeId === "database" || this.curResourceTypeId === "localdb") {
        param = {
          datasetId: this.dataSetCache.af_id
        };
      }
      if(this.curResourceTypeId === 'localdb'){  //本地数据库设置
          ...
          console.info(dbuser1[0].paramValue);
          ...
          for(var p = 0 ; p < pars.length ; p++){
            if(pars[p].paramName == 'db_type'){
               ...
               console.info("数据库类型"+this.dataSrcValue.dsType);
               break;
            }
          }
    ...
    */
    queryTabFields(paramObj) {
      ...
      if (this.curResourceTypeId === "dataasset") {
        ...
        if(this.dataSrcValue.dsType === 'postgresql'){ //pg库
      ...
      //   }
      // })
      console.info(_this.dataSrcValue.resourceTypeId);
      _this
      ...
      for (let index = 0; index < oriEntityArr.length; index++) {
        ...
        */
          ...
          if(this.dataSrcValue){
            ...
            if(dsType.includes('mysql') || dsType.includes('gbase')){
              sign = 'dbName';
            }else if(dsType.includes('postgresql')){  //pg库
    ...
    formatSavedData(entityData, colsData) {
      ...
      if (this.curResourceTypeId === "database" || this.curResourceTypeId === "localdb") {
        ...
        for(var i = 0 ;i <entityData.length;i++){
          if(this.curResourceTypeId === "localdb"){
              entityData[i]["flag"] = "0";
          }else{
              entityData[i]["flag"] = "1";
          }
        ...
        .then(response => {
          if (response.status == 200 && response.data.respResult == "1") {
            ...
            this.queryTbFields({  //回显查询字段
              ...
              }else if( response.data.respResult == 1 &&  response.data.respData && response.data.respData.length === 0){
                _this.$message.warning("字段列表已退订！");
              } 
              else {
    ...
    */
    queryDimInfoList() {
      console.info( this.curResourceTypeId);
      var _this = this;
    ...
    dataSrcSelChange(value) {
      ...
      if (value != "") {
        ...
        if(value.parentResourceTypeId === "dataasset" || value.parentResourceTypeId === "database"){
          ...
          console.info(dbuser[0].paramValue);
          //隐藏用户模式下拉
          this.isShowDiv = false;
      ...
      this.queryDataSource({
        ...
        .then(response => {
          if (response.data.respResult == 1) {
            ...
            if (
              this.dataSetCache &&
              this.dataSetCache.af_id != "" &&
              !this.isDatasetQuery
            ) {
              //如果是编辑页面初始进来，要查询数据集信息
              this.curAfId = this.dataSetCache.af_id;
              this.queryDataSet();
            }
          } else {
  ...
  activated() {
    ...
    if (this.dataSetCache && this.dataSetCache.af_id != "") {
      this.isDatasetQuery = false;
      this.connId = this.dataSetCache.conn_id || "";
    }
    this.getAllDataSrc();
  ...
  mounted() {
    this.realTabChsName = [];
    let pageInfo = JSON.parse(window.sessionStorage.getItem("dataSetCache"));
